    ...
    render() {
        return (
            <div class="viewport" >
                ...
                <div class="column2" style={{ marginTop: '80px' }}>
                    <div class="map">
                        ...
                        <div class="panel" >
                            ...
                            <div className="datalake">
                                <div className="datalake_ods panel">
                                    <div class='panel'>ods内容</div>
                                    <div class='panel'>ods内容</div>
                                    <div className='panel'>ods内容</div>
                                </div>
                                <div className="datalake_center">
                                    <div>数据治理</div>
                                </div>
                                <div className="datalake-dw panel">
                                    <div className='panel'>dw内容</div>
                                    <div className='panel'>dw内容</div>
                                    <div className='panel'>dw内容</div>
                                </div>
                            </div>
                        ...
                        <div className="panel" >
                            <h3>业务系统</h3>
                            <div className="dataExhibition">
                                <div className="panel">内容1</div>
                                <div className="panel">内容1</div>
                                <div className="panel">内容1</div>
                                <div className="panel">内容1</div>
                            </div>
                    ...
                    <div className="data panel">
                        <div className="dataletf panel">
                            <h3>数据资产管理</h3>
                            <div className="datainner">
                                <div className="panel">管理1</div>
                                <div className="panel">管理1</div>
                                <div className="panel">管理1</div>
                                <div className="panel">管理1</div>
                                <div className="panel">管理1</div>
                        ...
                        <div className="dataright panel">
                            <h3>数据开发与计算</h3>
                            <div className="datainner">
                                <div className="panel">计算1</div>
                                <div className="panel">计算1</div>
                                <div className="panel">计算1</div>
                                <div className="panel">计算1</div>
                                <div className="panel">计算1</div>
